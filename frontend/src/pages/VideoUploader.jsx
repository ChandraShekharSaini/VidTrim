...
const VideoUpload = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`https://vimtrim.onrender.com/upload?id=${currentUser?._id}`, formData, {
                headers: {
            ...
            navigate(`/download-video?compressedVideoUrl=${encodeURIComponent(token)}`);
