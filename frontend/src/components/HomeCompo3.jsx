    ...
    return (
        <section className='w-full py-10 bg-[#eceeee] '>
            <div className='w-[90%] py-10 px-5 sm:px-10 md:px-20 flex flex-col gap-10 justify-center  items-center mx-auto bg-[#ffffff] rounded-3xl shadow-2xl'>
                <div className='font-Boldonse text-center  text-[#404040] text-[25px] mt-6 sm:text-[30px] md:text-[32px] lg:text-[45px]' >
                    Compress and convert videos, repurpose content, edit with AI, and more
                </div>


                <div className='md:flex md:flex-row gap-10   text-[22px] sm:text-[25px] font-Oswald font-light mt-5 sm:mt-10'>
                    <p>
                ...
                <img className='w-full lg:w-[90%] lg:h-[90%]' src="https://cdn-site-assets.veed.io/cdn-cgi/image/width=1536,quality=75,format=auto/morethan_8c1e4a3d1e_ab0f207654/morethan_8c1e4a3d1e_ab0f207654.png" alt="" />
            </div>
        </section>
    )
}
